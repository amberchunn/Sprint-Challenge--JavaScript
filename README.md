...
.Map returns a new array and leaves the original array intact. .forEach returns undefined. This allows .map to chain with other methods, unlike .forEach which can't as it returns undefined.

2. What is the difference between a function and a method?

A function is a separate piece of code that does something with our data. A method is a function that is attached to an object literal.

3. What is closure?

Closure allows functions to keep data stored. It prevents variables from being overwritten or conflicting with the Global memory.
...
To bind the attributes of the new object to the Parent class
